//Al caricamento della pagina + costanti
  ...
  const id= 'https://striveschool-api.herokuapp.com/api/product/${productId}'
    ...
    function displayProducts(products) {
        ...
        products.forEach(product => {
            ...
            productImg.className = "product-img"; // Dichiaro img del prodotto
            ...
            productDetails.textContent = "+";      // Bottone dettagli del prodotto
    
            // Aggiungo un listener per reindirizzare alla pagina dei dettagli del prodotto
